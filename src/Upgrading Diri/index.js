  ...
  return (
    <>
      ...
      <div className="my-14 px-3 max-w-7xl mx-auto">
        ...
        <div>
          <div className="flex mt-32 mb-10 lg:justify-start justify-center">
            <h1 class="font-poppins font-bold text-xl text-darkgreen p-5 bg-yellow-300">KELAS 2 Arah</h1>
          </div>
        </div>

      </div>
      <div class="bg-gray-300 mb-52 py-20">
        <h1 class="font-poppins font-bold text-5xl text-center text-darkgreen italic tracking-widest">COMING <br/>SOON</h1>
      </div>
    </>
  );
}
