    ...
    return (
        <>
                    ...
                    <div className="py-6 md:py-0 px-3 max-w-7xl absolute w-full h-full flex flex-col md:flex-row flex-row align-center">
                        <div className="flex flex-col justify-center">
                            <div className="mx-auto">
                                <h1 className="font-poppins text-white text-2xl md:text-4xl lg:text-5xl font-bold mb-5 font-poppins" style={{ lineHeight: '1.16' }}>
                        ...
                        >
                            <SwiperSlide>
                                <div className="inline lg:flex h-full">
                                    <img src={Component21} className="self-center mx-auto max-h-full" />
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="inline lg:flex h-full">
                                    <img src={Component22} className="self-center mx-auto max-h-full" />
                                </div>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className="inline lg:flex h-full">
                                    <img src={Component23} className="self-center mx-auto max-h-full" />
                                </div>
                            </SwiperSlide>
                        </Swiper>
                    </div>
            ...
            <div className="mt-10 py-10 max-w-7xl mx-auto px-3">
                <div>
                    <h1 className="text-darkgreen font-bold text-4xl text-center font-poppins">Upgrading Diri</h1>
                </div>
                <Swiper
                ...
                >
                    ...
                    <SwiperSlide>
                        <div className="flex justify-center align-center h-full">
                            <img src={programmingwebsite} className="self-center w-64 lg:w-auto" />
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="flex justify-center align-center h-full">
                            <img src={programmingandroid} className="self-center w-64 lg:w-auto" />
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="flex justify-center align-center h-full">
                            <img src={programminggames} className="self-center w-64 lg:w-auto" />
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="flex justify-center align-center h-full">
                    ...
                    <SwiperSlide>
                        <div className="flex justify-center align-center h-full">
                            <img src={seminarmotivasi} className="self-center w-64 lg:w-auto" />
                        </div>
                    </SwiperSlide>
                </Swiper>
                ...
                <div className="flex flex-col md:flex-row md:justify-center space-y-10 md:space-y-0 md:space-x-24">
                    ...
                    <div className="flex flex-col justify-center align-center">
                        ...
                        <div className="flex my-5">
                            <ButtonHijau className="self-start" href="/produk" text="Pelajari Selengkapnya" />
                        </div>
                    </div>
                </div>
            </div>
            <div className="my-10" style={{ background: '#D2D8CE' }}>
                <div className="pt-10 pb-1 px-3 max-w-7xl mx-auto">
                    <div className="flex justify-center">
                        <h1 className="text-darkgreen font-bold text-xl font-poppins border-b-4 border-yellow-400 pb-2">Aktivitas Terkini ></h1>
                    </div>
                    <Swiper
                        className="max-w-full my-10"
                        spaceBetween={0}
                    ...
                    >
                        <SwiperSlide>
                            <div className="flex justify-center align-center h-full">
                                <img src={Group173} className="self-center max-h-full max-w-full" />
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="flex justify-center align-center h-full">
                                <img src={Group174} className="self-center max-h-full max-w-full" />
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="flex justify-center align-center h-full">
                                <img src={Group175} className="self-center max-h-full max-w-full" />
                            </div>
                        </SwiperSlide>
                    </Swiper>
                </div>
