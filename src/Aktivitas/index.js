    ...
    <>
      <div className="my-20 px-3 max-w-7x1 mx-auto">
        ...
        <div className="relative pt-52 pb-28">
          <div
            className="absolute md:top-0 md:bottom-20 md:left-48 md:w-80 md:h-48 md:shadow-lg rounded md:rounded-lg md:max-w-4xl"
            style={{ backgroundColor: "#093334" }}
          ></div>
          <div className="absolute md:top-0 md:left-52">
            <img src={Apprenticeship} className="md:w-80 md:h-44" />
          </div>
          <div
            className="absolute md:top-0 md:bottom-20 md:right-56 md:w-80 md:h-48 md:shadow-lg rounded md:rounded-lg  md:max-w-4xl"
            style={{ backgroundColor: "#093334" }}
          ></div>
